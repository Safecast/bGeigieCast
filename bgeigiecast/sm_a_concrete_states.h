...
class ResolveEndpointState : public ApiReporterState {
 public:
  explicit ResolveEndpointState(IApiConnector& context, Reading* reading);
  virtual ~ResolveEndpointState() = default;
