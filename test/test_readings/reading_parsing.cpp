...
void reading_parsing(void) {
  ...
  TEST_ASSERT_EQUAL(204, r2.get_device_id());
  ...
  TEST_ASSERT_EQUAL_FLOAT(56.7047, r2.get_latitude());
  TEST_ASSERT_EQUAL_FLOAT(14.2078, r2.get_longitude());
  ...
  TEST_ASSERT_EQUAL(0x46, r2.get_checksum());
